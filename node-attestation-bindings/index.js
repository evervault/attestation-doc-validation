...
switch (platform) {
    ...
    switch (arch) {
      case "arm64":
        localFileExisted = existsSync(
          join(__dirname, "evervault-attestation-bindings.android-arm64.node")
        );
        try {
          if (localFileExisted) {
  ...
  case "darwin":
    localFileExisted = existsSync(
      join(__dirname, "evervault-attestation-bindings.darwin-universal.node")
    );
    try {
      if (localFileExisted) {
    ...
    switch (arch) {
      case "x64":
        localFileExisted = existsSync(
          join(__dirname, "evervault-attestation-bindings.darwin-x64.node")
        );
        try {
          if (localFileExisted) {
  ...
  case "freebsd":
    ...
    localFileExisted = existsSync(
      join(__dirname, "evervault-attestation-bindings.freebsd-x64.node")
    );
    try {
      if (localFileExisted) {
