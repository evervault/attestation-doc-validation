use der::asn1::{BitString, ObjectIdentifier, OctetString, UIntRef};
use der::Sequence;
  ...
  fn to_curve(&self) -> Curve {
    match self {
      ...
      Self::Secp256r1 => {
        ...
        Curve {
          a: octet_string_from_hex("FFFFFFFF00000001000000000000000000000000FFFFFFFFFFFFFFFFFFFFFFFC").unwrap(),
          b: octet_string_from_hex("5AC635D8AA3A93E7B3EBBD55769886BC651D06B0CC53B0F63BCE3C3E27D2604B").unwrap(),
